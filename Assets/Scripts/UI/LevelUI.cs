...
public class LevelUI : MonoBehaviour
{
    ...
    private void Construct(
        ...
        ChestLock chestLock,
        Chest chest,
        ChestLockUI chestLockUI,
        CompleteLevelUI completeLevelUI,
        BattleStartTextUI battleStartTextUI)
    {
        _stick = stick;
    ...
    {
        _battlePlatform.OnPlayerEnterBattleZone += OnPlayerEnterBattleZone;
    ...
    private void ShowLock() => _chestLockUI.Show(true);

    private void HideLock() => _chestLockUI.Show(false);

    private void ShowCompleteUI() => _completeLevelUI.Show();

    private void OnPlayerEnterBattleZone()
    {
